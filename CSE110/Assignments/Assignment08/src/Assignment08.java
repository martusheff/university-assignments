...
class Assignment08 {
    ...
    static String getPlayerName() {
        System.out.println("Enter new player first name  --> ");
        String firstName = scnr.next();
        System.out.println("Enter new player last name   --> ");
    ...
    static double getAttackStat() {
        System.out.println("Enter player's new attack stat --> ");
        return scnr.nextDouble();
    }

    static double getBlockStat() {
        System.out.println("Enter player's new block stat  --> ");
        return scnr.nextDouble();
    }
}